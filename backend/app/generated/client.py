...
SCHEMA_PATH = Path('C:/Users/rayya/OneDrive/Desktop/PROJECTS/chatapp-pythia/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\rayya\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    adminaction: 'actions.AdminActionActions[models.AdminAction]'
    channel: 'actions.ChannelActions[models.Channel]'
    message: 'actions.MessageActions[models.Message]'
    channelmember: 'actions.ChannelMemberActions[models.ChannelMember]'
    mention: 'actions.MentionActions[models.Mention]'
    messagereaction: 'actions.MessageReactionActions[models.MessageReaction]'
    ...
    def __init__(
        ...
        *,
        ...
        self.adminaction = actions.AdminActionActions[models.AdminAction](self, models.AdminAction)
        ...
        self.channelmember = actions.ChannelMemberActions[models.ChannelMember](self, models.ChannelMember)
        self.mention = actions.MentionActions[models.Mention](self, models.Mention)
        self.messagereaction = actions.MessageReactionActions[models.MessageReaction](self, models.MessageReaction)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/rayya/OneDrive/Desktop/PROJECTS/chatapp-pythia/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    adminaction: 'AdminActionBatchActions'
    channel: 'ChannelBatchActions'
    message: 'MessageBatchActions'
    channelmember: 'ChannelMemberBatchActions'
    mention: 'MentionBatchActions'
    messagereaction: 'MessageReactionBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.adminaction = AdminActionBatchActions(self)
        self.channel = ChannelBatchActions(self)
        self.message = MessageBatchActions(self)
        self.channelmember = ChannelMemberBatchActions(self)
        self.mention = MentionBatchActions(self)
        self.messagereaction = MessageReactionBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ChannelMemberBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class MessageReactionBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
